    ...
    <div className="formula-card">
      ...
      <div className="home-two-columns">
        <div className="home-column">
          ...
          <p>All formulas are based on the PMBOK Guide and include detailed explanations and interpretations.</p>
        </div>
        
        <div className="home-column">
          <img src={girlAtDesk} alt="Girl at desk" className="home-image" />
      ...
      <div className="description">
        <p style={{textAlign: 'center', marginTop: '2rem'}}>
          Choose a formula category from the menu to explore all available calculators.
        </p>
      </div>
